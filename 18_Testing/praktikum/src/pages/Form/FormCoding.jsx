  ...
  return (
    <>
      ...
      <form onSubmit={handleSubmit} className={styles.centerForm}>
        ...
        <label>
          Email: <br />
          <input required className={styles.input} type="email" name="email" value={data.email} onChange={handleChange} />
        </label>
        <label>
          No Handphone: <br />
          <input type="number" name="noHandphone" value={data.noHandphone} onChange={handleChange} />
        </label>
        <label>
          Latar Belakang Pendidikan: <br />
          <input required type="radio" name="pendidikan" value="IT" checked={data.pendidikan === "IT"} onChange={handleChange} />
          IT
          <input type="radio" name="pendidikan" value="Non IT" checked={data.pendidikan === "Non IT" ? true : false} onChange={handleChange} />
          Non IT
        </label>
        <br />
        <label>
        ...
        <label>
          ...
          <input required type="file" name="suratKesungguhan" ref={suratKesungguhan} onChange={handleChange} />
        </label>
        <label>
          Harapan Untuk Coding Bootcamp Ini: <br />
          <textarea type="text" name="harapan" value={data.harapan} onChange={handleChange} />
        </label>
